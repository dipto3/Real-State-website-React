...
import WhiteShadow1Svg from "./svg/WhiteShadow1Svg";
import WhiteShadow2Svg from "./svg/WhiteShadow2Svg";
import WhiteShadow3Svg from "./svg/WhiteShadow3Svg";
            ...
            <div className="-mx-4 flex flex-wrap items-center">
              <div className="w-full px-4 lg:w-1/2">
                <div className="mb-12 max-w-[540px] lg:mb-0">
                  <h2 className="mb-5 text-3xl font-bold leading-tight text-dark dark:text-dark sm:text-[40px] sm:leading-[1.2]">
                    Innovative Tools for Real Estate Excellence
                  </h2>

                  <p className="mb-10 text-base leading-relaxed text-bodyColor dark:text-dark-6">
